...
每个游戏会显示“等待中 / 未开启更新 / 没有可用更新源 / 版本已最新，无需更新 /
已完成更新 / 更新失败”之一。全部处理完毕后页面会保留，不会自动返回操作界面。

结果页默认选中底部“返回操作界面”。同时按 2+7 可在游戏列表和返回按钮间切换；在游戏
列表中用 1/4 号键选择项目，按 5 号键显示或隐藏详细信息。详细信息会列出每个更新源是
